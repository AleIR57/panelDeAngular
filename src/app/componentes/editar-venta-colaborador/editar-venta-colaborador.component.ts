...
@Component({
  selector: 'app-editar-venta-colaborador',
  templateUrl: './editar-venta-colaborador.component.html',
  styleUrls: ['./editar-venta-colaborador.component.css']
})
export class EditarVentaColaboradorComponent implements OnInit {
